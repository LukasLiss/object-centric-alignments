from localocpa.algo.conformance.precision_and_fitness.variants import replay_context
import localocpa.algo.conformance.precision_and_fitness.utils as utils
